...
import ranking_features from './ranking_features';
    ...
    return(
       ...
       <div className = "flex flex-row bg-green-50 min-h-screen">
           ...
           <div className='w-2/3 md:w-5/6 py-16 px-16 items-center flex flex-col'>
                ...
                <h1 className="font-bold text-lg text-gray-700 pb-4">Features Based Ranking</h1>
     ...
     >
       ...
       <Scatter data={ranking_features}>
        {ranking_features.map((entry, index) => (
