        ...
        <>
         <div className='flex flex-row bg-green-50 min-h-screen'>
            ...
            <div className='w-2/3 md:w-5/6 py-16 px-16 items-center flex flex-col'>
                ...
                <h1 className="font-bold text-lg text-gray-700 pb-4">NDVI | The vegetation index</h1>
                <p className="text-md text-gray-700">The Normalised Difference Vegetation Index is a GIS index value that represents the presence of vegetation in a region. Following graph shows a comparision between the actual and Optimum NDVI values of different areas in Pakistan. The areas are identified by their id.</p>
                </div>
       ...
       It is recommended to use a desktop/laptop PC for better understanding of Graphical Information
            ...
            <ResponsiveContainer className="hidden md:block" width="100%" aspect={2}>
                <LineChart data={pdata}>
                    ...
                    <Legend />
                    <Tooltip />
                    <Line dataKey="mean_ndvi"
                        stroke="brown" activeDot={{ r:2}} />
                    <Line dataKey="optimum_NDVI"
