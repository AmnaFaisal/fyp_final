...
const Biotite = () => {
    return(
       ...
       <div className='w-2/3 md:w-5/6 py-16 px-16 items-center flex flex-col'>
            ...
            <p className="text-md text-gray-700">The plotted graph below shows the correlational relationship between NDVI and Biotite values observed in the dataset.</p>
            </div>
       ...
       It is recommended to use a desktop/laptop PC for better understanding of Graphical Information
        ...
        <YAxis type="number" dataKey="mean_biotite" />
