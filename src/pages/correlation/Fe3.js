...
const Fe3 = () => {
    return(
       ...
       <div className='w-2/3 md:w-5/6 py-16 px-16 items-center flex flex-col'>
            ...
            <p className="text-md text-gray-700">The plotted graph below shows the correlational relationship between NDVI and Ferrous III values observed in the dataset.</p>
            </div>
       ...
       <ScatterChart className="hidden md:block" width={600} height={400}>
        ...
        <YAxis type="number" dataKey="mean_fe3" />
