...
const Ndbi = () => {
    return(
       ...
       <div className='w-2/3 md:w-5/6 py-16 px-16 items-center flex flex-col'>
            ...
            <h1 className="font-bold text-lg text-gray-700 pb-4">NDBI</h1>
            <p className="text-md text-gray-700">The plotted graph below shows the correlational relationship between NDVI and NDBI values observed in the dataset.</p>
            </div>
       ...
       <ScatterChart className="hidden md:block" width={600} height={400}>
        ...
        <YAxis type="number" dataKey="mean_ndbi" />
